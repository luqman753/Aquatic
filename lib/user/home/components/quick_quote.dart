...
import 'package:stable_aquatic/user/home/components/shipping_fromto.dart';
...
import '../../../models/GenericModel.dart';
import '../../../models/SharedPref.dart';
import '../../../size_config.dart';


class QuickQoute extends StatefulWidget {
  const QuickQoute({Key? key}) : super(key: key);
...
class _QuickQouteState extends State<QuickQoute> with TickerProviderStateMixin {
  ...
  ShippingModel from =  ShippingModel(
        city: "1",
        zipCode: "",
        country: '',
      ),
  ...
  PackageDimensions packageDimensions =  PackageDimensions(title: "1");
