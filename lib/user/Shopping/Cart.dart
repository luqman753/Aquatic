...
import 'package:stable_aquatic/models/GenericModel.dart';

import '../../AppTheme.dart';
import '../../auth/pre_sign_in/components/quick_quote.dart';
import '../../components/custom_widgets/skeleton_container.dart';
import '../../components/custom_widgets/text_field.dart';
import '../../models/SharedPref.dart';
import '../../size_config.dart';
import '../shipping_payment/Payment.dart';
...
class _CartState extends State<Cart> {
  ...
  TextEditingController fOrgController =  TextEditingController(),
      fNameController =  TextEditingController(),
      fAddressController =  TextEditingController(),
      fApartController =  TextEditingController(),
      fCityController =  TextEditingController(),
      fZipController =  TextEditingController(),
      fStateController =  TextEditingController(),
      fPhoneController =  TextEditingController();
                                ...
                                child: Card(
                                  child: ListTile(
                                    ...
                                    trailing: Column(
                                      ...
                                      children: [
                                        Text(
                                          "Qty: ${(snapshot.data as List)[index]
                                                      ["qty"]}",
                                        ),
                                        Text(
  ...
  ShippingModel from =  ShippingModel(city: ""),
      to =  ShippingModel(city: "");
                                          ...
                                          child: Card(
                                            child: ListTile(
                                              ...
                                              subtitle: Text("${(snapshot.data
                                                              as List)[index]
                                                          ["address"]}, ${(snapshot.data as List)[index]
                                                          ["city"]}, ${(snapshot.data as List)[index]
                                                          ["state"]}, ${(snapshot.data as List)[index]
                                                          ["zipCode"]}"),
                                            ),
                                          ),
                                        )
